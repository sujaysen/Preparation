...
class ThirdOption:
	def __init__(self,root):
		self.root = root
		self.root.title("Log Details For 192.168.42.27")
		self.root.geometry("1135x570+232+165")

		#================================ right side img ==================================
		img3 = Image.open(r"/home/justdial/Preparation/SystemDesign/Log_View_System/images/just3.jpg")
