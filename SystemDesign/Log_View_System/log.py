...
from first import FirstOption
from second import SecondOption
from third import ThirdOption
...
class HotelManagementSystem:
	def __init__(self,root):
		self.root = root
		self.root.title("Log View System")
		...
		cust_btn = Button(btn_frame,text="192.168.24.132",command=self.first_option_details,width=22,font=("times new roman",14,"bold"),bg="black",fg="gold",bd=0,cursor="hand1")
		cust_btn.grid(row=0,column=0,pady=1)

		room_btn = Button(btn_frame,text="192.168.41.75",command=self.second_option_details,width=22,font=("times new roman",14,"bold"),bg="black",fg="gold",bd=0,cursor="hand1")
		room_btn.grid(row=1,column=0,pady=1)

		detail_btn = Button(btn_frame,text="192.168.42.27",command=self.third_option_details,width=22,font=("times new roman",14,"bold"),bg="black",fg="gold",bd=0,cursor="hand1")
	...
	def first_option_details(self):
		self.new_window = Toplevel(self.root)
		self.app = FirstOption(self.new_window)

	def second_option_details(self):
		self.new_window = Toplevel(self.root)
		self.app = SecondOption(self.new_window)

	def third_option_details(self):
		self.new_window = Toplevel(self.root)
		self.app = ThirdOption(self.new_window)
